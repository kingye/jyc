...
"#,
    ...
    fn test_config_swap() -> Arc<ArcSwap<jyc_types::AppConfig>> {
    ...
    async fn test_close_command_deletes_thread_directory() {
        ...
        let storage = Arc::new(crate::message_storage::MessageStorage::new(&workspace));
        ...
        let thread_manager = Arc::new(ThreadManager::new(
            ...
            Arc::new(jyc_channels::email::outbound::EmailOutboundAdapter::new(
                ...
                Arc::new(crate::message_storage::MessageStorage::new(&workspace)),
            )),
            Arc::new(StaticAgentService::new("test reply")),
            tokio_util::sync::CancellationToken::new(),
            jyc_types::HeartbeatConfig::default(),
            "".into(),
            PathBuf::from("/tmp/templates"),
            test_config_swap(),
            "test".to_string(),
            workspace.clone(),
            crate::metrics::MetricsHandle::noop(),
        ));
